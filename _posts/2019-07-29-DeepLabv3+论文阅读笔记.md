...
> ![DeepLabv3+题目.png](/img/Journal/DeepLabv3+题目.png)
...
![DeepLabv3+模型对比.png](/img/Journal/DeepLabv3+模型对比.png)
...
![DeepLabv3+.png](/img/Journal/DeepLabv3+.png)

![深度分离卷积.png](/img/Journal/深度分离卷积.png)
...
![Xception的改进.png](/img/Journal/Xception的改进.png)
...
* 用1x1的卷积减少feature map的通道数
    ![1x1减少通道数.png](/img/Journal/1x1减少通道数.png)

* 使用3x3的卷积细化上采样特征
    ![3x3细化特征.png](/img/Journal/3x3细化特征.png)
    
* 使用低维度特征来帮助获得更多细节
    ![低维度弥补特征.png](/img/Journal/低维度弥补特征.png)

***2. 用ResNet-101（DeepLabv3的结构） 和 Xception 做编码器的实验对比。***
1. 用ResNet-101做编码器
* ![ResNet-101实验对比.png](/img/Journal/ResNet-101实验对比.png)
* 测试了3种变体：没有使用decoder（用作基础对比）、使用decoder、下采样32倍。
2. 用Xception做编码器
* ![Xception实验对比.png](/img/Journal/Xception实验对比.png)
* 用五组实验做对比：没有使用decoder（作为基础对比）、使用了decoder的、增加了深度分离卷积的、在COCO数据集上进行了预训练的、在JFT数据集上进行了预训练的

训练效果的对比：
![DeepLabv3+四种模型的训练效果.png](/img/Journal/DeepLabv3+四种模型的训练效果.png)
